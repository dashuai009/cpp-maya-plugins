...
public:
    ...
    ~viewRenderOverrideFrameCache() override;
...
public:
    ...
    ~PreviewTargetsOperation() override;
...
public:
    ...
    ~CaptureTargetsOperation() override;
