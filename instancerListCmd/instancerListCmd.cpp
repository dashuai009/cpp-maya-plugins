...
// DESCRIPTION:
//
// Produces the MEL command "listParticleInstances".
// 
...
// MFnInstancer will be used to enumerate each instancer's instances, exercising
// both the instancesForParticle() and allInstances() methods.
