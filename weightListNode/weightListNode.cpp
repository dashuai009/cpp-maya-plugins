...
// DESCRIPTION:
//
// Produces the node "weightList".
//
// This example demonstrates how to work with multi of multi attributes
// as found in deformer nodes. 
// 
// A weightList node is created by the plug-in. The compute() method of the
// plug-in demonstrates how to manipulate multi of multi attributes while
// initialize() shows how to create the attribute.   
//
// It is an example implementation of a node which reads and writes a multi of
// multi of float attribute in the compute() method. The definition of this
// multi of multi of float attribute is the same as the weightList attribute
// for deformer. 
//        
